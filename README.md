...
<p align="center"><a href="https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/tree/master/docs"><strong>Docs: Getting Started →</strong></a></p>
<p align="center"><a href="https://libauth.org/#md:api-overview">API Reference</a></p>

<p align="center">
  <a href="https://www.npmjs.com/package/@hoangcung1804npm/voluptatem-accusamus-ipsam"><img src="https://img.shields.io/npm/v/@hoangcung1804npm/voluptatem-accusamus-ipsam.svg" alt="NPM version" /></a>
  <a href="https://codecov.io/gh/hoangcung1804npm/voluptatem-accusamus-ipsam"><img src="https://img.shields.io/codecov/c/github/hoangcung1804npm/voluptatem-accusamus-ipsam/master.svg" alt="Codecov" /></a>
  <a href="https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/hoangcung1804npm/voluptatem-accusamus-ipsam/ci.yml?branch=master" alt="CI" /></a>
  ...
  <a href="https://www.npmjs.com/package/@hoangcung1804npm/voluptatem-accusamus-ipsam"><img alt="npm downloads" src="https://img.shields.io/npm/dm/@hoangcung1804npm/voluptatem-accusamus-ipsam"></a>
  <a href="https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam"><img src="https://img.shields.io/github/stars/hoangcung1804npm/voluptatem-accusamus-ipsam.svg?style=social&logo=github&label=Stars" alt="GitHub stars" /></a>
</p>
...
To get started, install `@hoangcung1804npm/voluptatem-accusamus-ipsam`:

```sh
npm install @hoangcung1804npm/voluptatem-accusamus-ipsam
# OR
yarn add @hoangcung1804npm/voluptatem-accusamus-ipsam
```

And import the functionality you need:

```ts
import { secp256k1 } from '@hoangcung1804npm/voluptatem-accusamus-ipsam';
...
- [Installation](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/install.md)
- [Handling Errors](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/errors.md)
- [Cryptography](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/crypto.md)
- [Keys](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/keys.md)
- [Addresses](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/addresses.md)
- [Verifying Transactions](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/verify-transactions.md)
- [Wallets & Transaction Creation](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/docs/wallets.md)
...
Libauth's test suite includes a set of cross-implementation Virtual Machine Bytecode (VMB) test vectors for each supported VM. See [`Libauth VMB Tests`](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/src/lib/vmb-tests/readme.md) for details.
...
Pull Requests welcome! Please see [`CONTRIBUTING.md`](https://github.com/hoangcung1804npm/voluptatem-accusamus-ipsam/blob/master/.github/CONTRIBUTING.md) for details.
